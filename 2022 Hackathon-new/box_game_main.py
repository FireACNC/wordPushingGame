...
imgs = [PhotoImage(file="image/wall.png"),
        PhotoImage(file='image/human.png'),
        PhotoImage(file='image/box.png'),
        PhotoImage(file='image/white_bg.png'),
        PhotoImage(file='image/terminal.png'),
        PhotoImage(file='image/t_man.png'),
        PhotoImage(file='image/star.png')]
